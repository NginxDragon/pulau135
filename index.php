    ...
    <div class="w3-row">
        ...
        <div class="w3-card w3-round w3-white">
          <div class="w3-container">
            ...
            <div class="promo">
              ...
              <p><i class="fa fa-percent fa-fw w3-margin-right w3-text-theme"></i><a href="../support/docs/pdf/musicool/" target="_blank">Promo Musicool</a><span style="color:red;font-weight:bold"> New</span> </p>
        ...
        <div class="w3-card w3-round">
          <div class="w3-white">
            ...
            <div id="Demo1" class="w3-hide w3-container">
              <a class="w3-button w3-theme-d1 w3-margin-bottom" href="https://www.musicoolpromo.com/" target="_blank">Musicool</a>
            ...
            <button onclick="myFunction('Demo2')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-calendar-check-o fa-fw w3-margin-right"></i> MOM</button>
            <div id="Demo2" class="w3-hide w3-container">
              <ul>
                <li><a href="../support/docs/excel/mom/" target="_blank">MOM Meeting 26 Mei 2020</a></li>
      ...
      <div class="w3-col m7">
        ...
        <div class="w3-container w3-card w3-white w3-round w3-margin">
          ...
          <a class="w3-button w3-theme-d1 w3-margin-bottom" href="https://www.musicoolpromo.com/jaringan-kami" target="_blank">Musicool Jaringan</a>
        ...
        <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
          ...
          <img src="img/bpo36.jpg" style="width:100%" class="w3-margin-bottom">
          <p>Infomedia Your Digital CX Partner By Telkom Indonesia. 36 th BPO KEBANGGAAN INDONESIA</p>
      ...
      <div class="w3-col m2">
        ...
        <div class="w3-card w3-round w3-white w3-padding-16 w3-center">
          <div class="layanan">
            <a href="../support/docs/excel/ptpl/" target="_blank">Harga Retail PTPL</a>
        ...
        <div class="w3-card w3-round w3-white w3-padding-16 w3-center">
          <div class="layanan">
            <a href="../support/docs/excel/pds/" target="_blank">Pelayanan PDS</a>
          </div>
        </div>
        <br>
